  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          SearchBanner(
            title: "Kapan Mau Di Wujudkan\n Wistlist Kamu?",
            titleSize: 30,
            imageUrl: "assets/images/banner3.jpg",
            page: 'Wistlist',
          ),
          Expanded(
            child: wishlistItems2.isEmpty
                ? Center(
                    child: Column(
                        ...
                        confirmDismiss: (direction) async {
                          if (direction == DismissDirection.endToStart) {
                            ...
                            await showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  title: const Text("Yakin Ingin Hapus Data Wishlist"),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                                        dismiss = true;
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(content: Text('Delete Item')),
                                        );
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 0) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const ListWisata()),
            );
          }
        },
      ),
